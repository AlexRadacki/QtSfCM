...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        currentTimeMinutes = new QLCDNumber(timeLineBox);
        currentTimeMinutes->setObjectName(QStringLiteral("currentTimeMinutes"));
        currentTimeMinutes->setGeometry(QRect(440, 60, 71, 41));
        QFont font;
        font.setBold(false);
        ...
        currentTimeSeconds = new QLCDNumber(timeLineBox);
        currentTimeSeconds->setObjectName(QStringLiteral("currentTimeSeconds"));
        currentTimeSeconds->setGeometry(QRect(500, 60, 81, 41));
        ...
        currentTimeSeconds_2 = new QLCDNumber(timeLineBox);
        currentTimeSeconds_2->setObjectName(QStringLiteral("currentTimeSeconds_2"));
        currentTimeSeconds_2->setGeometry(QRect(570, 60, 81, 41));
        ...
        currentTimeSeconds_2->setDigitCount(2);
        currentTimeSeconds_2->setMode(QLCDNumber::Dec);
        currentTimeSeconds_2->setSegmentStyle(QLCDNumber::Flat);
        currentTimeSeconds_2->setProperty("value", QVariant(88));
        label_2 = new QLabel(timeLineBox);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(500, 40, 101, 71));
        QFont font1;
        font1.setPointSize(26);
        label_2->setFont(font1);
        groupBox = new QGroupBox(timeLineBox);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(260, 19, 421, 91));
        label_2->raise();
